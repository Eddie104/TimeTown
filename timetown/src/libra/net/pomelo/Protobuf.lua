...
Protobuf.util      = Util
Protobuf.parser    = import(".protobuf.Parser")
Protobuf.codec     = import(".protobuf.Codec")
Protobuf.encoder   = import(".protobuf.Encoder")
Protobuf.decoder   = import(".protobuf.Decoder")
